...
function Run-SecurityMonitoring {
    ...
    Write-Host "   Application Insights: https://portal.azure.com/#@silverjunk08gmail.onmicrosoft.com/resource/subscriptions/61d9a026-8bd4-41de-8aeb-44722187b1da/resourceGroups/rg-denoise-audio/providers/Microsoft.Insights/components/appi-4ositsvdlpac6/overview" -ForegroundColor $Colors.Dim
}
